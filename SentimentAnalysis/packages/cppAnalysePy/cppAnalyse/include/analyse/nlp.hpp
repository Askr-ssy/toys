...
namespace nlp{
    ...
    class model{
        ...
        public:
            ...
            // 模型入口
            std::map<string,string> predict(std::map<string,string> &input_content){
        ...
        public:
            ...
            const std::string basewords_filename;
            const std::string stopwords_filename;
            const std::string clearwords_filename;
            const std::string modiwords_filename;
            const std::string machinewords_filename;
            const std::string sensitivewords_filename;
            const std::string inversewords_filename;
            const std::string triggerwords_filename;
            const std::string selfwords_filename;

            const std::string jieba_dict_path;
            const std::string jieba_model_path;
            const std::string jieba_user_dict_path;
            const std::string jieba_idf_path;
            const std::string jieba_stopWord_path;
